...
var ProcessImage = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, width, height, imagePath, file;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                imagePath = path_1.default.join(process.env.IMAGE_DIRECTORY, "thumbnails", name);
                return [4 /*yield*/, (0, imageResize_1.default)(imagePath, name, width, height)];
            case 1:
                file = _b.sent();
                if (!file) {
